...
import br.udesc.wutb.listener.ListenerConnection;
 ...
 * 
 */
public class ActivityConnection extends AnimatedActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Params.setActivityConnection(this);
		Params.setActivity(this);
		
		listener = new ListenerConnection(this);
